  ...
  useEffect(() => {
    ...
    const markers = [
      {
        ...
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipP5WzxsPDVWVHbasg13knzHDCTakkqJs6_bgjXJ=w426-h240-k-no',
      ...
      },
      {
        ...
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipObY2Pv_hCYM7FGDodpb37pKDmnUBx-M5TM9fxX=w408-h306-k-no',
        gmapsLink: '',
      },
      {
        ...
        popupDescription: 'Jakarta',
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipO9P8ew7C0KXOF8Bsb4LXDOhnv_MIwySp8MBmyb=w408-h816-k-no',
      ...
      },
      {
        ...
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipPdcJXVfs0N9IBA-3fRMxgUCjlKCYNG_rVa1PGh=w408-h839-k-no',
      ...
      },
      {
        ...
        popupDescription: 'Jakarta',
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipPl3qYAwqhsziIuAUnJUivRB8UBG0Zue0RUollQ=w408-h544-k-no',
      ...
      },
      {
        ...
        popupDescription: 'Depok',
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipMAJPXZE8pK5dJK8otQxcTVXe0UUv0V3oxoE8kV=w408-h461-k-no',
      ...
      },
      {
        ...
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipOZrB4j5iD6zPGrrMpcvLZ51bLA20lfeAA1yh4-=w408-h904-k-no',
      ...
      },
      {
        ...
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipPC6VA0EtKudc1NZH2EvgLrvzIE_ksEwyFD6OJp=w408-h306-k-no',
      ...
      },
      {
        ...
        popupDescription: 'Bekasi',
        cardDescription: 'This is card description 1 dmc ma vnz n n v amd cma d and cn sn cnaksn cn',
        cardImage: 'https://lh5.googleusercontent.com/p/AF1QipPW2ZScT5fOis3o9fg2F7lX0xZd9nLCrODeopHp=w408-h725-k-no',
    ...
    markers.forEach((markerData) => {
      const marker = L.marker(markerData.coordinates)
        .addTo(map)
        .bindPopup(`<b>${markerData.title}</b><br />${markerData.popupDescription}`)
        .openPopup();
      ...
      {showCard && (
        <Card className="card">
          ...
          <Card.Body>
            ...
            <Button className="gmaps-button" variant="primary" href={gmapsLink} target="_blank">
              Open in Google Maps
            </Button>
          </Card.Body>
        </Card>
